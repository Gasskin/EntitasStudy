...
public partial class InputContext {
    ...
    public InputEntity SetInput(UnityEngine.Vector2Int newPos) {
        if (hasInput) {
        ...
        entity.AddInput(newPos);
        return entity;
    }

    public void ReplaceInput(UnityEngine.Vector2Int newPos) {
        var entity = inputEntity;
        if (entity == null) {
            entity = SetInput(newPos);
        } else {
            entity.ReplaceInput(newPos);
        }
    }
...
public partial class InputEntity {
    ...
    public void AddInput(UnityEngine.Vector2Int newPos) {
