...
public partial class Contexts {
    ...
    public const string Positon = "Positon";

    [Entitas.CodeGeneration.Attributes.PostConstructor]
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.PrimaryEntityIndex<GameEntity, UnityEngine.Vector2Int>(
            Positon,
            game.GetGroup(GameMatcher.Positon),
            (e, c) => ((PositonComponent)c).pos));
    }
}

public static class ContextsExtensions {

    public static GameEntity GetEntityWithPositon(this GameContext context, UnityEngine.Vector2Int pos) {
        return ((Entitas.PrimaryEntityIndex<GameEntity, UnityEngine.Vector2Int>)context.GetEntityIndex(Contexts.Positon)).GetEntity(pos);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
